...
public class TextView_Subheading extends TextView {
    public TextView_Subheading(Context context) {
        super(context);
        init();
    }

    public TextView_Subheading(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @SuppressLint("Instantiatable")
	public TextView_Subheading(Context context, AttributeSet attrs, int defStyle) {
