...
public class TextView_SubheadingBold extends TextView {
    public TextView_SubheadingBold(Context context) {
        super(context);
        init();
    }

    public TextView_SubheadingBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @SuppressLint("Instantiatable")
	public TextView_SubheadingBold(Context context, AttributeSet attrs, int defStyle) {
