...
public class TextView_Body1 extends TextView {
    public TextView_Body1(Context context) {
        super(context);
        init();
    }

    public TextView_Body1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @SuppressLint("Instantiatable")
	public TextView_Body1(Context context, AttributeSet attrs, int defStyle) {
